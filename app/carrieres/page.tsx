...
import {
  ...
  Rocket, Users, BookOpen, TrendingUp, Heart, Shield,
  Zap, Settings, Car, Monitor, Server,
  GraduationCap,
} from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  description:
    'Rejoignez NOISIM et participez à la transformation industrielle de l\'Afrique. Découvrez nos offres d\'emploi pour ingénieurs, techniciens et développeurs à Pointe-Noire et Brazzaville.',
}

const offers = [
  {
    id: 1,
    title: 'Technicien Systèmes & Réseaux (CDD)',
    ...
    <>
      ...
      <section className="relative pt-36 pb-24 bg-dark overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-xl mb-4">
              Chez NOISIM, chaque ingénieur, technicien et développeur contribue directement
              à des projets qui transforment des infrastructures réelles. Rejoignez une équipe
      ...
      <section className="section-padding bg-surface">
        <div className="container-custom">
          <SectionHeader
            tag="Offres d'emploi"
            title={`${offers.length} postes ouverts`}
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="flex flex-wrap gap-2 mb-5">
                        {offer.benefits.map((b) => (
                          <span
                            key={b}
                            className="text-[10px] font-semibold bg-primary/8 text-primary px-2.5 py-1 rounded-full"
                          >
                            {b}
                          </span>
                        ))}
                      ...
                      {/* CTA */}
                      <Link
                        href={`/contact?poste=${encodeURIComponent(offer.title)}`}
      ...
      <section className="section-padding bg-gradient-to-br from-secondary to-dark relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <AnimatedSection className="max-w-2xl mx-auto text-center">
            ...
            <Link href="/contact?poste=Candidature+spontan%C3%A9e" className="btn-white inline-flex text-base">
